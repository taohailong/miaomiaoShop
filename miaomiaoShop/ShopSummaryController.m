...
#import "ShopSummaryController.h"
...
@interface ShopSummaryController ()<UITableViewDataSource,UITableViewDelegate,UIAlertViewDelegate>
{
    UITableView* _table;
...
@implementation ShopSummaryController
@synthesize errView;
-(void)checkUserLogState
{
    ...
    __weak ShopSummaryController* wSelf = self;
